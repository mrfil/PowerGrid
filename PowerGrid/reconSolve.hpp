...
Col <complex<T1>> reconSolve(Col <complex<T1>> data, TObj &Sg, RObj &R, Col <T1> kx, Col <T1> ky, Col <T1> kz, uword Nx,uword Ny, uword Nz, Col <T1> tvec, uword niter) {
