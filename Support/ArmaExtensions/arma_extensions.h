...
// The armadillo classes define these macros to include files at the end of the class so you can modify them
// without touching the header files, must come prior to <armadillo>
#define ARMA_EXTRA_MAT_PROTO ArmaExtensions/Mat_extra_bones.hpp
#define ARMA_EXTRA_MAT_MEAT ArmaExtensions/Mat_extra_meat.hpp

// The armadillo classes define these macros to include files at the end of the class so you can modify them
// without touching the header files, must come prior to <armadillo>
#define ARMA_EXTRA_COL_PROTO ArmaExtensions/Col_extra_bones.hpp
#define ARMA_EXTRA_COL_MEAT ArmaExtensions/Col_extra_meat.hpp
